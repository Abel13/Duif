...
export const mockPostalTrafficPets: PostalTrafficPet[] = [
  {
    ...
    route: {
      ...
      returnStartAt: "2026-07-12T08:00:00.000Z",
      returnArrivalAt: "2026-07-14T08:00:00.000Z",
    },
    speciesKey: "species.carrierPigeon",
    visibility: "friend",
  },
  {
    id: "traffic-anonymous-atlantic",
    route: {
      origin: { latitude: -8.0476, longitude: -34.877 },
      destination: { latitude: 14.7167, longitude: -17.4677 },
      outboundStartAt: "2026-07-10T06:00:00.000Z",
      outboundArrivalAt: "2026-07-12T06:00:00.000Z",
    },
  ...
  },
  {
    ...
    route: {
      ...
      outboundStartAt: "2026-07-10T12:00:00.000Z",
      outboundArrivalAt: "2026-07-13T00:00:00.000Z",
    },
