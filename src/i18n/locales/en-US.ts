...
export const enUS = {
  ...
  auth: {
    ...
    subtitle: "Use email and password to link your local session to the seeded prototype profile.",
    unavailableTitle: "Supabase is not configured",
    unavailableDescription:
      "Set the local environment variables to test login. The app keeps using mocks meanwhile.",
    loadingSession: "Loading session",
    signedInTitle: "Active session",
    signedInDescription: "Your local profile is already linked to the postal notebook.",
  ...
  inventory: {
    eyebrow: "Postal album",
    title: "Inventory",
    subtitle: "An album of stamps, keepsakes, route marks, and equipment found during travels.",
    categoriesLabel: "Album categories",
