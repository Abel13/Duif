...
export const enUS = {
  ...
  postalJobs: { eyebrow: "Postal board", title: "Available jobs", description: "Each mascot can choose an official delivery without using personal items.", distance: "Distance", cargo: "Cargo", seeds: "Seeds", accept: "Accept job", replace: "Replace", depart: "Confirm departure", error: "We couldn't update this postal job.", templates: { farol: { title: "Lens for the lighthouse", description: "Bring the polished lens before fog covers the coast." }, horta: { title: "Garden seeds", description: "A box of seeds must arrive before the rain." }, estacao: { title: "Station timetables", description: "Deliver the new departure board to the postal station." }, biblioteca: { title: "Library maps", description: "The map room is waiting for its catalogued navigation charts." }, oficina: { title: "Workshop parts", description: "The workshop needs components to repair its presses." }, observatorio: { title: "Celestial charts", description: "Bring sky maps for the night observation." } } },
