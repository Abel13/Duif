...
export const enUS = {
  ...
  tutorial: {
    eyebrow: "First route",
    continue: "Got it",
    start: { title: "A route to learn", description: "Your mascot will take a short journey from the Postal Nest to Messenger Station and return in 16 minutes.", action: "Start first route" },
