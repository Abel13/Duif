...
export const enUS = {
  ...
  officialPostcards: {
    ...
    cities: {
      ...
      curitiba: { name: "Curitiba Postcard", description: "A permanent postcard earned by completing a journey to Curitiba.", alt: "Curitiba illustrated among a park, lake, araucaria trees, and its urban skyline." },
      ...
      campoGrande: { name: "Campo Grande Postcard", description: "A permanent postcard earned by completing a journey to Campo Grande.", alt: "Campo Grande illustrated with red soil, trumpet trees, macaws, and its urban skyline." },
      ...
      teresina: { name: "Teresina Postcard", description: "A permanent postcard earned by completing a journey to Teresina.", alt: "Teresina illustrated at the meeting of its rivers among a bridge, carnauba palms, and cityscape." },
      joaoPessoa: { name: "João Pessoa Postcard", description: "A permanent postcard earned by completing a journey to João Pessoa.", alt: "João Pessoa illustrated among sea cliffs, Atlantic Forest, ocean, and coastal skyline." },
      aracaju: { name: "Aracaju Postcard", description: "A permanent postcard earned by completing a journey to Aracaju.", alt: "Aracaju illustrated by the Sergipe River with mangroves, boats, and a tree-lined waterfront." },
      cuiaba: { name: "Cuiabá Postcard", description: "A permanent postcard earned by completing a journey to Cuiabá.", alt: "Cuiabá illustrated among tiled roofs, cerrado, river, trumpet trees, and distant plateaus." },
      ...
      macapa: { name: "Macapá Postcard", description: "A permanent postcard earned by completing a journey to Macapá.", alt: "Macapá illustrated beside the Amazon estuary under equatorial light." },
