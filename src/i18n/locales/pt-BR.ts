...
export const ptBR = {
  ...
  officialPostcards: {
    ...
    cities: {
      saoPaulo: { name: "Cartão de São Paulo", description: "Um cartão postal permanente conquistado ao concluir uma viagem para São Paulo.", alt: "São Paulo ilustrada com horizonte urbano, avenida arborizada e ipês amarelos." },
      ...
      beloHorizonte: { name: "Cartão de Belo Horizonte", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Belo Horizonte.", alt: "Belo Horizonte ilustrada diante da Serra do Curral, com ipês e jabuticabeiras." },
      ...
      fortaleza: { name: "Cartão de Fortaleza", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Fortaleza.", alt: "Fortaleza ilustrada com orla luminosa, jangadas, coqueiros e horizonte urbano." },
      ...
      goiania: { name: "Cartão de Goiânia", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Goiânia.", alt: "Goiânia ilustrada entre arquitetura art déco, parques, ipês e vegetação do cerrado." },
      ...
      portoAlegre: { name: "Cartão de Porto Alegre", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Porto Alegre.", alt: "Porto Alegre ilustrada diante do Guaíba durante um pôr do sol dourado." },
      maceio: { name: "Cartão de Maceió", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Maceió.", alt: "Maceió ilustrada com águas claras, recifes, jangadas, coqueiros e horizonte urbano." },
      ...
      natal: { name: "Cartão de Natal", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Natal.", alt: "Natal ilustrada entre dunas, vegetação costeira, estuário, mar e horizonte urbano." },
      ...
      portoVelho: { name: "Cartão de Porto Velho", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Porto Velho.", alt: "Porto Velho ilustrada às margens do rio Madeira, com porto, barcos e floresta." },
      ...
      florianopolis: { name: "Cartão de Florianópolis", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Florianópolis.", alt: "Florianópolis ilustrada entre baía, morros de Mata Atlântica, dunas e barcos de pesca." },
      boaVista: { name: "Cartão de Boa Vista", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Boa Vista.", alt: "Boa Vista ilustrada junto ao rio Branco, com traçado radial, lavrado e buritis." },
      rioBranco: { name: "Cartão de Rio Branco", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Rio Branco.", alt: "Rio Branco ilustrada entre o rio Acre, passarelas, casas coloridas e floresta." },
      vitoria: { name: "Cartão de Vitória", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Vitória.", alt: "Vitória ilustrada entre baía, morros de granito, manguezais, barcos e cidade insular." },
      palmas: { name: "Cartão de Palmas", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Palmas.", alt: "Palmas ilustrada entre lago, avenidas, cerrado, buritis e Serra do Lajeado." },
