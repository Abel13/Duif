...
export const ptBR = {
  ...
  officialPostcards: {
    ...
    cities: {
      ...
      curitiba: { name: "Cartão de Curitiba", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Curitiba.", alt: "Curitiba ilustrada entre parque, lago, araucárias e horizonte urbano." },
      ...
      campoGrande: { name: "Cartão de Campo Grande", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Campo Grande.", alt: "Campo Grande ilustrada com terra vermelha, ipês, araras e horizonte urbano." },
      ...
      teresina: { name: "Cartão de Teresina", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Teresina.", alt: "Teresina ilustrada no encontro dos rios, entre ponte, carnaúbas e paisagem urbana." },
      joaoPessoa: { name: "Cartão de João Pessoa", description: "Um cartão postal permanente conquistado ao concluir uma viagem para João Pessoa.", alt: "João Pessoa ilustrada entre falésias, Mata Atlântica, mar e horizonte costeiro." },
      aracaju: { name: "Cartão de Aracaju", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Aracaju.", alt: "Aracaju ilustrada junto ao rio Sergipe, com manguezais, barcos e orla arborizada." },
      cuiaba: { name: "Cartão de Cuiabá", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Cuiabá.", alt: "Cuiabá ilustrada entre casario, cerrado, rio, ipês e chapadas distantes." },
      ...
      macapa: { name: "Cartão de Macapá", description: "Um cartão postal permanente conquistado ao concluir uma viagem para Macapá.", alt: "Macapá ilustrada junto ao estuário amazônico sob a luz da linha do Equador." },
