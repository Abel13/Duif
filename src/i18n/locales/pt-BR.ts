...
export const ptBR = {
  ...
  postalJobs: { eyebrow: "Quadro postal", title: "Trabalhos disponíveis", description: "Cada mascote pode escolher uma entrega oficial sem usar seus itens pessoais.", distance: "Distância", cargo: "Carga", seeds: "Sementes", accept: "Aceitar trabalho", replace: "Trocar", depart: "Confirmar partida", error: "Não foi possível atualizar este trabalho postal.", templates: { farol: { title: "Lente para o farol", description: "Leve a lente polida antes que a neblina cubra a costa." }, horta: { title: "Sementes da horta", description: "Uma caixa de sementes precisa chegar antes da chuva." }, estacao: { title: "Horários da estação", description: "Entregue a nova tabela de partidas à estação postal." }, biblioteca: { title: "Mapas da biblioteca", description: "A mapoteca aguarda cartas de navegação catalogadas." }, oficina: { title: "Peças para a oficina", description: "A oficina precisa de componentes para reparar suas prensas." }, observatorio: { title: "Cartas celestes", description: "Leve os mapas do céu para a observação noturna." } } },
