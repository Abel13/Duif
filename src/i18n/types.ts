...
export type TranslationDictionary = {
  ...
  postalJobs: { eyebrow: string; title: string; description: string; distance: string; cargo: string; seeds: string; xp: string; accept: string; replace: string; depart: string; error: string; templates: { farol: { title: string; description: string }; farolSignal: { title: string; description: string }; horta: { title: string; description: string }; hortaSeedlings: { title: string; description: string }; estacao: { title: string; description: string }; estacaoSignals: { title: string; description: string }; biblioteca: { title: string; description: string }; bibliotecaFolios: { title: string; description: string }; oficina: { title: string; description: string }; oficinaInk: { title: string; description: string }; observatorio: { title: string; description: string }; observatorioLenses: { title: string; description: string } } };
...
export type TranslationKey =
  ...
  | "nest.selectionReady"
  | "nest.confirmAction"
  | "postalJobs.eyebrow" | "postalJobs.title" | "postalJobs.description" | "postalJobs.distance" | "postalJobs.cargo" | "postalJobs.seeds" | "postalJobs.xp" | "postalJobs.accept" | "postalJobs.replace" | "postalJobs.depart" | "postalJobs.error"
