...
export type TranslationDictionary = {
  ...
  nestHub: {
    eyebrow: string; title: string; tagline: string; currencySummary: string; seeds: string; crystals: string; settings: string; closeSettings: string; defaultAvatar: string; profileName: string; nestName: string; nestOf: string; location: string; levelZero: string; xpZero: string; sections: string; profileTitle: string; profileDescription: string; mascotTitle: string; mascotDescription: string; mailboxTitle: string; mailboxDescription: string; atNest: string; traveling: string; newCorrespondence: string; travelingTitle: string; noTravelTitle: string; noTravelDescription: string;
  };
  profile: {
    eyebrow: string;
    email: string;
...
export type TranslationKey =
 ...
 | "landmarks.halongBayThienCung.name" | "landmarks.halongBayThienCung.description" | "landmarks.halongBayThienCung.alt"
  ...
  | "exclusiveMissions.title" | "exclusiveMissions.eyebrow" | "exclusiveMissions.badge" | "exclusiveMissions.destination" | "exclusiveMissions.objective" | "exclusiveMissions.dossier" | "exclusiveMissions.briefing" | "exclusiveMissions.returnRecord" | "exclusiveMissions.closeDossier" | "exclusiveMissions.expires" | "exclusiveMissions.expired" | "exclusiveMissions.accept" | "exclusiveMissions.depart" | "exclusiveMissions.error"
  | "assetStudio.eyebrow"
  | "assetStudio.title"
