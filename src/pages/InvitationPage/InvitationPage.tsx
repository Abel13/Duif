...
import { resolveReferralInvitation, storeReferralInvitation } from "../../integrations/supabase/referrals";
...
export function InvitationPage() {
  ...
  function accept() { storeReferralInvitation(token); navigate("/auth?mode=signup"); }
