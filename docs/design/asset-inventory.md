...
| `postcard.city.3448439.front` | postcardArtwork · v1 ativa | `postcards/cities/sao-paulo.webp` · 1200×800 · 182.0 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a São Paulo | ativo-verificado |
...
| `postcard.city.3470127.front` | postcardArtwork · v1 ativa | `postcards/cities/belo-horizonte.webp` · 1200×800 · 183.8 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a Belo Horizonte | ativo-verificado |
...
| `postcard.city.3399415.front` | postcardArtwork · v1 ativa | `postcards/cities/fortaleza.webp` · 1200×800 · 170.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a Fortaleza | ativo-verificado |
...
| `postcard.city.3462377.front` | postcardArtwork · v1 ativa | `postcards/cities/goiania.webp` · 1200×800 · 175.3 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a Goiânia | ativo-verificado |
...
| `postcard.city.3452925.front` | postcardArtwork · v1 ativa | `postcards/cities/porto-alegre.webp` · 1200×800 · 129.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Porto Alegre | ativo-verificado |
| `postcard.city.3395981.front` | postcardArtwork · v1 ativa | `postcards/cities/maceio.webp` · 1200×800 · 159.9 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Maceió | ativo-verificado |
...
| `postcard.city.3394023.front` | postcardArtwork · v1 ativa | `postcards/cities/natal.webp` · 1200×800 · 136.5 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Natal | ativo-verificado |
...
| `postcard.city.3662762.front` | postcardArtwork · v1 ativa | `postcards/cities/porto-velho.webp` · 1200×800 · 126.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Porto Velho | ativo-verificado |
...
| `postcard.city.3463237.front` | postcardArtwork · v1 ativa | `postcards/cities/florianopolis.webp` · 1200×800 · 142.4 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Florianópolis | ativo-verificado |
| `postcard.city.3664980.front` | postcardArtwork · v1 ativa | `postcards/cities/boa-vista.webp` · 1200×800 · 182.9 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Boa Vista | ativo-verificado |
| `postcard.city.3662574.front` | postcardArtwork · v1 ativa | `postcards/cities/rio-branco.webp` · 1200×800 · 164.5 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Rio Branco | ativo-verificado |
| `postcard.city.3444924.front` | postcardArtwork · v1 ativa | `postcards/cities/vitoria.webp` · 1200×800 · 136.4 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Vitória | ativo-verificado |
| `postcard.city.3474574.front` | postcardArtwork · v1 ativa | `postcards/cities/palmas.webp` · 1200×800 · 182.3 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Palmas | ativo-verificado |
