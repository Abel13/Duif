...
- os 50 Lugares Memoráveis possuem pares ativos de sticker e cartão, com arquivos empacotados em
  `public/assets/landmarks/` e `public/assets/postcards/landmarks/`;
...
| `postcard.city.3456166.front` | postcardArtwork · v2 ativa | `postcards/cities/nova-friburgo.webp` · 1200×800 · 156.3 KB | compositor, caixa postal, Álbum | Praça do Suspiro e teleférico; nome/descrição/alt traduzidos | visita canônica a Nova Friburgo | ativo-verificado |
| `postcard.city.3457952.front` | postcardArtwork · v2 ativa | `postcards/cities/manhuacu.webp` · 1200×800 · 133.0 KB | compositor, caixa postal, Álbum | Igreja Matriz de São Lourenço; nome/descrição/alt traduzidos | visita canônica a Manhuaçu | ativo-verificado |
| `postcard.city.3458449.front` | postcardArtwork · v2 ativa | `postcards/cities/londrina.webp` · 1200×800 · 133.0 KB | compositor, caixa postal, Álbum | Catedral Metropolitana; nome/descrição/alt traduzidos | visita canônica a Londrina | ativo-verificado |
| `postcard.city.3448439.front` | postcardArtwork · v2 ativa | `postcards/cities/sao-paulo.webp` · 1200×800 · 140.1 KB | compositor, caixa postal, Álbum | Estação da Luz; nome/descrição/alt traduzidos | visita canônica a São Paulo | ativo-verificado |
| `postcard.city.3451190.front` | postcardArtwork · v1 ativa | `postcards/cities/rio-de-janeiro.webp` · 1200×800 · 174.4 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica ao Rio de Janeiro | ativo-verificado |
| `postcard.city.3470127.front` | postcardArtwork · v2 ativa | `postcards/cities/belo-horizonte.webp` · 1200×800 · 126.2 KB | compositor, caixa postal, Álbum | Igreja da Pampulha; nome/descrição/alt traduzidos | visita canônica a Belo Horizonte | ativo-verificado |
| `postcard.city.3450554.front` | postcardArtwork · v1 ativa | `postcards/cities/salvador.webp` · 1200×800 · 164.2 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a Salvador | ativo-verificado |
| `postcard.city.3399415.front` | postcardArtwork · v2 ativa | `postcards/cities/fortaleza.webp` · 1200×800 · 141.7 KB | compositor, caixa postal, Álbum | Ponte dos Ingleses; nome/descrição/alt traduzidos | visita canônica a Fortaleza | ativo-verificado |
| `postcard.city.3663517.front` | postcardArtwork · v1 ativa | `postcards/cities/manaus.webp` · 1200×800 · 149.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a Manaus | ativo-verificado |
| `postcard.city.3469058.front` | postcardArtwork · v1 ativa | `postcards/cities/brasilia.webp` · 1200×800 · 160.3 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a Brasília | ativo-verificado |
| `postcard.city.3464975.front` | postcardArtwork · v3 ativa | `postcards/cities/curitiba.webp` · 1200×800 · 157.7 KB | compositor, caixa postal, Álbum | estufa do Jardim Botânico; nome/descrição/alt traduzidos | visita canônica a Curitiba | ativo-verificado |
| `postcard.city.3390760.front` | postcardArtwork · v1 ativa | `postcards/cities/recife.webp` · 1200×800 · 166.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica ao Recife | ativo-verificado |
| `postcard.city.3462377.front` | postcardArtwork · v2 ativa | `postcards/cities/goiania.webp` · 1200×800 · 124.4 KB | compositor, caixa postal, Álbum | Monumento às Três Raças; nome/descrição/alt traduzidos | visita canônica a Goiânia | ativo-verificado |
| `postcard.city.3405870.front` | postcardArtwork · v1 ativa | `postcards/cities/belem.webp` · 1200×800 · 181.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Belém | ativo-verificado |
| `postcard.city.3452925.front` | postcardArtwork · v2 ativa | `postcards/cities/porto-alegre.webp` · 1200×800 · 93.7 KB | compositor, caixa postal, Álbum | Usina do Gasômetro; nome/descrição/alt traduzidos | visita canônica a Porto Alegre | ativo-verificado |
| `postcard.city.3395981.front` | postcardArtwork · v2 ativa | `postcards/cities/maceio.webp` · 1200×800 · 111.7 KB | compositor, caixa postal, Álbum | Farol da Ponta Verde; nome/descrição/alt traduzidos | visita canônica a Maceió | ativo-verificado |
| `postcard.city.3388368.front` | postcardArtwork · v1 ativa | `postcards/cities/sao-luis.webp` · 1200×800 · 168.7 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a São Luís | ativo-verificado |
| `postcard.city.3467747.front` | postcardArtwork · v3 ativa | `postcards/cities/campo-grande.webp` · 1200×800 · 174.0 KB | compositor, caixa postal, Álbum | Bioparque Pantanal; nome/descrição/alt traduzidos | visita canônica a Campo Grande | ativo-verificado |
| `postcard.city.3394023.front` | postcardArtwork · v2 ativa | `postcards/cities/natal.webp` · 1200×800 · 137.3 KB | compositor, caixa postal, Álbum | Forte dos Reis Magos; nome/descrição/alt traduzidos | visita canônica a Natal | ativo-verificado |
| `postcard.city.3386496.front` | postcardArtwork · v3 ativa | `postcards/cities/teresina.webp` · 1200×800 · 153.9 KB | compositor, caixa postal, Álbum | Ponte Estaiada João Isidoro França; nome/descrição/alt traduzidos | visita canônica a Teresina | ativo-verificado |
| `postcard.city.3397277.front` | postcardArtwork · v3 ativa | `postcards/cities/joao-pessoa.webp` · 1200×800 · 105.8 KB | compositor, caixa postal, Álbum | Farol do Cabo Branco; nome/descrição/alt traduzidos | visita canônica a João Pessoa | ativo-verificado |
| `postcard.city.3471872.front` | postcardArtwork · v3 ativa | `postcards/cities/aracaju.webp` · 1200×800 · 126.4 KB | compositor, caixa postal, Álbum | Arcos da Orla de Atalaia; nome/descrição/alt traduzidos | visita canônica a Aracaju | ativo-verificado |
| `postcard.city.3465038.front` | postcardArtwork · v3 ativa | `postcards/cities/cuiaba.webp` · 1200×800 · 122.5 KB | compositor, caixa postal, Álbum | Igreja de Nossa Senhora do Bom Despacho; nome/descrição/alt traduzidos | visita canônica a Cuiabá | ativo-verificado |
| `postcard.city.3662762.front` | postcardArtwork · v2 ativa | `postcards/cities/porto-velho.webp` · 1200×800 · 155.7 KB | compositor, caixa postal, Álbum | Três Caixas d’Água; nome/descrição/alt traduzidos | visita canônica a Porto Velho | ativo-verificado |
| `postcard.city.3396016.front` | postcardArtwork · v3 ativa | `postcards/cities/macapa.webp` · 1200×800 · 159.2 KB | compositor, caixa postal, Álbum | Fortaleza de São José de Macapá; nome/descrição/alt traduzidos | visita canônica a Macapá | ativo-verificado |
| `postcard.city.3463237.front` | postcardArtwork · v2 ativa | `postcards/cities/florianopolis.webp` · 1200×800 · 148.8 KB | compositor, caixa postal, Álbum | Ponte Hercílio Luz; nome/descrição/alt traduzidos | visita canônica a Florianópolis | ativo-verificado |
| `postcard.city.3664980.front` | postcardArtwork · v2 ativa | `postcards/cities/boa-vista.webp` · 1200×800 · 156.6 KB | compositor, caixa postal, Álbum | Orla Taumanan; nome/descrição/alt traduzidos | visita canônica a Boa Vista | ativo-verificado |
| `postcard.city.3662574.front` | postcardArtwork · v2 ativa | `postcards/cities/rio-branco.webp` · 1200×800 · 142.6 KB | compositor, caixa postal, Álbum | Palácio Rio Branco; nome/descrição/alt traduzidos | visita canônica a Rio Branco | ativo-verificado |
| `postcard.city.3444924.front` | postcardArtwork · v2 ativa | `postcards/cities/vitoria.webp` · 1200×800 · 145.2 KB | compositor, caixa postal, Álbum | Terceira Ponte; nome/descrição/alt traduzidos | visita canônica a Vitória | ativo-verificado |
| `postcard.city.3474574.front` | postcardArtwork · v2 ativa | `postcards/cities/palmas.webp` · 1200×800 · 125.6 KB | compositor, caixa postal, Álbum | Praça dos Girassóis e Palácio Araguaia; nome/descrição/alt traduzidos | visita canônica a Palmas | ativo-verificado |
...
| Mapa e controles | 6 / 6 | 41 Lugares Memoráveis propostos, além dos 9 ativos; catálogo e briefs em `world-landmark-catalog.md` | estados de colisão/desbloqueio (`proposta`) | alta · catálogo mundial | alto | briefs, fidelidade cultural e leitura em tamanho mínimo |
