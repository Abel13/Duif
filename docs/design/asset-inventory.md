...
| `postcard.city.3464975.front` | postcardArtwork · v1 ativa | `postcards/cities/curitiba.webp` · 1200×800 · 177.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos; cartão CSS | visita canônica a Curitiba | ativo-verificado |
...
| `postcard.city.3467747.front` | postcardArtwork · v1 ativa | `postcards/cities/campo-grande.webp` · 1200×800 · 152.1 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Campo Grande | ativo-verificado |
...
| `postcard.city.3386496.front` | postcardArtwork · v1 ativa | `postcards/cities/teresina.webp` · 1200×800 · 163.9 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Teresina | ativo-verificado |
| `postcard.city.3397277.front` | postcardArtwork · v1 ativa | `postcards/cities/joao-pessoa.webp` · 1200×800 · 152.1 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a João Pessoa | ativo-verificado |
| `postcard.city.3471872.front` | postcardArtwork · v1 ativa | `postcards/cities/aracaju.webp` · 1200×800 · 145.6 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Aracaju | ativo-verificado |
| `postcard.city.3465038.front` | postcardArtwork · v1 ativa | `postcards/cities/cuiaba.webp` · 1200×800 · 163.9 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Cuiabá | ativo-verificado |
...
| `postcard.city.3396016.front` | postcardArtwork · v1 ativa | `postcards/cities/macapa.webp` · 1200×800 · 121.0 KB | compositor, caixa postal, Álbum | nome/descrição/alt traduzidos | visita canônica a Macapá | ativo-verificado |
