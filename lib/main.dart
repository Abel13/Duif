...
import 'package:game_template/src/map/map.dart';
import 'package:game_template/src/map/map_screen.dart';
          ...
          routes: [
            GoRoute(
              ...
              pageBuilder: (context, state) => buildMyTransition(
                child: const MapScreen(key: Key('map')),
      ...
      child: MultiProvider(
        providers: [
          ...
          Provider<MapController>(
              lazy: false, create: (context) => MapController()),
        ],
